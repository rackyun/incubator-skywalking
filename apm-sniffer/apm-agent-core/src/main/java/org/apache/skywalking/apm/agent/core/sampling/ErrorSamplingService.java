 ...
 */
@DefaultImplementor
public class ErrorSamplingService implements BootService {
    private static final ILog logger = LogManager.getLogger(ErrorSamplingService.class);
    ...
    public void boot() throws Throwable {
        ...
        if (Config.Agent.ERROR_SAMPLE_N_PER_10_SECS > 0) {
            on = true;
