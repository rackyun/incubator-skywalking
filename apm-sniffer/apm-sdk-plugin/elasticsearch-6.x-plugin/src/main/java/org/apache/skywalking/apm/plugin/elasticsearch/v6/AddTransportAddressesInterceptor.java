...
public class AddTransportAddressesInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    private static final ILog logger = LogManager.getLogger(AddTransportAddressesInterceptor.class);
    ...
    public Object afterMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes,
        ...
        logger.info("elasticsearch v6 add discoveryNode {}", transportAddressCache.transportAddress());
