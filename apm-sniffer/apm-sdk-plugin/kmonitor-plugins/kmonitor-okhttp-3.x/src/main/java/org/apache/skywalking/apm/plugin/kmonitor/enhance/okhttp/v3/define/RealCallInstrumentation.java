 ...
 */
public class RealCallInstrumentation extends KmonitorClassEnhancePluginDefine {
     ...
     * Intercept class.
     */
    private static final String TRACE_INTERCEPT_CLASS = "org.apache.skywalking.apm.plugin.okhttp.v3.RealCallInterceptor";
    private static final String MONITOR_INTERCEPT_CLASS = "org.apache.skywalking.apm.plugin.kmonitor.enhance.okhttp.v3.RealCallInterceptor";
        ...
        return new MultiInstanceMethodsInterceptPoint[] {
            new MultiInstanceMethodsInterceptPoint() {
                ...
                public String[] getMethodsInterceptors() {
                    return new String[] {
                        TRACE_INTERCEPT_CLASS, MONITOR_INTERCEPT_CLASS
                    };
                }
