...
package org.apache.skywalking.apm.plugin.kmonitor.enhance.elasticsearch.v6.define;
...
public class TransportActionNodeProxyInstrumentation extends KmonitorClassEnhancePluginDefine {
    ...
    private static final String TRACE_INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.elasticsearch.v6.TransportActionNodeProxyInterceptor";
    private static final String ENHANCE_CLASS = "org.elasticsearch.action.TransportActionNodeProxy";
    private static final String MONITOR_INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.kmonitor.enhance.elasticsearch.v6.ElasticsearchMonitorInterceptor";
    ...
    protected String[] witnessClasses() {
        return new String[] {"org.elasticsearch.common.xcontent.ToXContentFragment"};
    }
}
