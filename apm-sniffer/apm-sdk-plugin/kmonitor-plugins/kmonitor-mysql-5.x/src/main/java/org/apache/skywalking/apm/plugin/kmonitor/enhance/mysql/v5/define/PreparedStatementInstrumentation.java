 ...
 * @author zhangxin
 */
public class PreparedStatementInstrumentation extends KmonitorClassEnhancePluginDefine {
        ...
        return new MultiInstanceMethodsInterceptPoint[] {
            new MultiInstanceMethodsInterceptPoint() {
                ...
                public String[] getMethodsInterceptors() {
                    return new String[] {Constants.SERVICE_METHOD_INTERCEPTOR, Constants.MONITOR_INTERCEPTOR};
                }
