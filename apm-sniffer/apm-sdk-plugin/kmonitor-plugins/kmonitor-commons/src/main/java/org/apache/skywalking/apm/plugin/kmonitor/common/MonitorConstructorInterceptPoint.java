 ...
 * <p>
 * ref to two others: {@link StaticMethodsInterceptPoint} and {@link MultiInstanceMethodsInterceptPoint}
 * <p>
 * Created by wusheng on 2016/11/29.
 */
public interface MonitorConstructorInterceptPoint {
    /**
     * Constructor matcher
     *
     ...
     */
    String[] getConstructorInterceptors();
}
