 ...
 * at 2019/5/5
 */
public class ProducerInterceptor implements InstanceMethodsAroundInterceptor {

    private static final ILog logger = LogManager.getLogger(ProducerInterceptor.class);
    private static final String PROBE_CONTEXT = "kafka.producer.probe.context";
    ...
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments,
        ...
        logger.debug("monitor producer send, topic={}", topic);
        ITimerContext context = metrics.probe().tag("topic", topic).timer("kafka.producer.msg").time();
