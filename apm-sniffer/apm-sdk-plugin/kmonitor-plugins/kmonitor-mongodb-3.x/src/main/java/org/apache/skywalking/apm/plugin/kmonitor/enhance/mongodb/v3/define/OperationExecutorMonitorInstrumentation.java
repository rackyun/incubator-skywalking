...
public class OperationExecutorMonitorInstrumentation extends KmonitorClassEnhancePluginDefine {
        ...
        return new MultiInstanceMethodsInterceptPoint[] {
            new MultiInstanceMethodsInterceptPoint() {
                ...
                public String[] getMethodsInterceptors() {
                    return new String[]{
                        "org.apache.skywalking.apm.plugin.mongodb.v3.MongoDBMethodInterceptor",
                        "org.apache.skywalking.apm.plugin.kmonitor.enhance.mongodb.v3.MongoDBMonitorInterceptor"
                    };
                }
